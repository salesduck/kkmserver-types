...
export enum SignMethodCalculation {
    /**
     * ПРЕДОПЛАТА 100% (Полная предварительная оплата до момента
     * передачи предмета расчета)
     */
    FULL_PREPAYMENT = 1,

    /**
     * ПРЕДОПЛАТА (Частичная предварительная оплата до момента
     * передачи предмета расчета)
     */
    ...
    /**
     * ПОЛНЫЙ РАСЧЕТ (Полная оплата, в том числе с учетом аванса
     * в момент передачи предмета расчета)
     */
    FULL_PAYMENT = 4,

    /**
     * ЧАСТИЧНЫЙ РАСЧЕТ И КРЕДИТ (Частичная оплата предмета расчета
     * в момент его передачи с последующей оплатой в кредит )
     */
    PARTIAL_SETTLEMENT_AND_CREDIT = 5,

    /**
     * ПЕРЕДАЧА В КРЕДИТ (Передача предмета расчета без его оплаты
     * в момент его передачи с последующей оплатой в кредит)
     */
    TRANSFER_ON_CREDIT = 6,

    /**
     * ОПЛАТА КРЕДИТА (Оплата предмета расчета после
     * его передачи с оплатой в кредит)
     */
    LOAN_PAYMENT = 7
}
...
export enum SignCalculationObject {
    /**
     * ТОВАР (наименование и иные сведения, описывающие товар)
     */
    PRODUCT = 1,
    ...
    /**
     * РАБОТА (наименование и иные сведения, описывающие работу)
     */
    JOB = 3,

    /**
     * УСЛУГА (наименование и иные сведения, описывающие услугу)
     */
    SERVICE = 4,

    /**
     * СТАВКА АЗАРТНОЙ ИГРЫ (при осуществлении деятельности по проведению азартных игр)
     */
    GAMBLING_BET = 5,

    /**
     * ВЫИГРЫШ АЗАРТНОЙ ИГРЫ (при осуществлении деятельности по проведению азартных игр)
     */
    WINNING_A_GAME_OF_GAMBLING = 6,

    /**
     * ЛОТЕРЕЙНЫЙ БИЛЕТ (при осуществлении деятельности по проведению лотерей)
     */
    LOTTERY_TICKET = 7,

    /**
     * ВЫИГРЫШ ЛОТЕРЕИ (при осуществлении деятельности по проведению лотерей)"
     */
    WINNING_THE_LOTTERY = 8,

    /**
     * ПРЕДОСТАВЛЕНИЕ РИД (предоставлении прав на использование результатов
     * интеллектуальной деятельности или средств индивидуализации)"
     */
    PROVISION = 9,

    /**
     * ПЛАТЕЖ (аванс, задаток, предоплата, кредит, взнос в счет оплаты, пени, штраф,
     * вознаграждение, бонус и иной аналогичный предмет расчета)"
     */
    PAYMENT = 10,

    /**
     * АГЕНТСКОЕ ВОЗНАГРАЖДЕНИЕ (вознаграждение (банковского)платежного агента/субагента,
     * комиссионера, поверенного или иным агентом)"
     */
    AGENTS_COMMISSION = 11,

    /**
     * СОСТАВНОЙ ПРЕДМЕТ РАСЧЕТА (предмет расчета, состоящем из предметов,
     * каждому из которых может быть присвоено вышестоящее значение"
     */
    COMPONENT_SUBJECT_OF_CALCULATION = 12,

    /**
     * ИНОЙ ПРЕДМЕТ РАСЧЕТА (предмет расчета, не относящемуся к предметам расчета,
     * которым может быть присвоено вышестоящее значение"
     */
    OTHER_SUBJECT_OF_CALCULATION = 13,

    /**
     * ИМУЩЕСТВЕННОЕ ПРАВО (передача имущественных прав)
     */
    PROPERTY_RIGHT = 14,
    ...
    /**
     * СТРАХОВЫЕ ВЗНОСЫ (суммы расходов, уменьшающих сумму налога (авансовых платежей) в
     * соответствии с пунктом 3.1 статьи 346.21 Налогового кодекса Российской Федерации)
     */
    INSURANCE_PREMIUMS = 16,

    /**
     * ТОРГОВЫЙ СБОР (суммы уплаченного торгового сбора)
     */
    TRADE_FEE = 17,
    ...
    /**
     * РАСХОД - суммы произведенных расходов в соответствии со статьей 346.
     * 16 Налогового кодекса Российской Федерации, уменьшающих доход
     */
    CONSUMPTION = 20,

    /**
     * ВЗНОСЫ НА ОБЯЗАТЕЛЬНОЕ ПЕНСИОННОЕ СТРАХОВАНИЕ ИП или ВЗНОСЫ НА ОПС ИП
     */
    CONTRIBUTIONS_TO_COMPULSORY_PENSION_INSURANCE_IP = 21,

    /**
     * ВЗНОСЫ НА ОБЯЗАТЕЛЬНОЕ ПЕНСИОННОЕ СТРАХОВАНИЕ или ВЗНОСЫ НА ОПС
     */
    CONTRIBUTIONS_TO_COMPULSORY_PENSION_INSURANCE = 22,

    /**
     * ВЗНОСЫ НА ОБЯЗАТЕЛЬНОЕ МЕДИЦИНСКОЕ СТРАХОВАНИЕ ИП или ВЗНОСЫ НА ОМС ИП
     */
    CONTRIBUTIONS_FOR_COMPULSORY_MEDICAL_INSURANCE_IP = 23,

    /**
     * ВЗНОСЫ НА ОБЯЗАТЕЛЬНОЕ МЕДИЦИНСКОЕ СТРАХОВАНИЕ или ВЗНОСЫ НА ОМС
     */
    CONTRIBUTIONS_FOR_COMPULSORY_HEALTH_INSURANCE = 24,

    /**
     * ВЗНОСЫ НА ОБЯЗАТЕЛЬНОЕ СОЦИАЛЬНОЕ СТРАХОВАНИЕ или ВЗНОСЫ НА ОСС
     */
    CONTRIBUTIONS_TO_COMPULSORY_SOCIAL_INSURANCE = 25,

    /**
     * ПЛАТЕЖ КАЗИНО - прием и выплата денежных средств при осуществлении
     * казино и залами игровых автоматов расчетов с использованием
     * обменных знаков игорного заведени
     */
    CASINO_PAYMENT = 26
}
